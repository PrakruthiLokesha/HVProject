...
Feature: Acknowledge the Review Comments from Functional Team Task by responding to client
...
Scenario: Acknowledge the Review Comments from Functional Team Task by responding to client
