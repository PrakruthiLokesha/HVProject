@6.4_SaveTheReviewCommentsandTakeActionTask
Feature: Send back to function team on Review Response and take action task
...
Scenario: Save the Review Response and take action task
...
#Navigate to Emails dashboard and verify
 ...
 Given I sort grid "[1]" by column "Received On"
    ...
    Given I sort grid "[1]" by column "Received On"
    Given I wait for "4" seconds
Given I verify grid "[1]" column "[1]" row "[1]" contains "Review Response from Accounting Manager Team"
Given I wait for "4" seconds
...
#Pick up the same task from the task page and observe
    ...
    Given I wait for "6" seconds
    Given I click on grid "[1]" column "[3]" row "[1]"
     When I verify text "Response comments" is presentGiven I wait for "6" seconds
    When I click on button "SAVE"
Then I wait for "5" seconds
