@7.1ResponseEmailThreadUpdateExistingRequest
Feature: Response Email Thread task-Update existing request option and confirm it
...
#I navigate to Email thread dashboard, select Update existing request option and confirm it
...
Given I wait for "5" seconds
Given I click on radio option "Update Existing Request"
Given I wait for "6" seconds
