...
Feature: Attach Documents to Client Service Request using Related Action-Attach Documents
  ...
  Background: Login to Appian environment
   ...
   When I wait for "5" seconds
   Then I verify text "Enter this comments to check the email subject - 09/12/2019 22:15:54" is present
   Then I wait for "5" seconds
   Then I click on link "Enter this comments to check the email subject - 09/12/2019 22:15:54"
	 Then I wait for "5" seconds
	 Then I logout
	 Then I tear down
