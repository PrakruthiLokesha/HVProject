...
Feature: Reply to Notes/Discussions By tagged User
  ...
  When I populate field "Notes" with "Enter this notes when user reply on added notes-09/09/2019 19:29:40"
  ...
  #View More details of added notes by clicking More Details icon
   ...
   Given I toggle box "Discussion History" visibility
   Given I wait for "2" seconds
   Given I populate field "Search Notes[2]" with "Enter this notes when user reply on added notes-09/09/2019 19:29:40"
   Given I wait for "5" seconds
