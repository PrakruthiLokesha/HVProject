  ...
  Background: Login to Appian environment
   ...
   Given I open "https://harbourvesttest.appiancloud.com/suite/sites/client-service"
    ...
    When I populate picker field "Tag People" with partially matching suggestions for
      | csa  |
      | test |
    When I populate field "Notes" with "Enter this notes when initiated add notes related action - 09/12/2019 22:15:54"
   ...
   Given I populate field "Search Notes[1]" with "Enter this notes when initiated add notes related action - 09/12/2019 22:15:54"
