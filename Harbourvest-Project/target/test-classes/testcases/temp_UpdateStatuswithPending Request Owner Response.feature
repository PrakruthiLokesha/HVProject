...
Feature: Update status related action submission with status Pending Request Owner Response
  ...
  Background: Login to Appian environment
   ...
   @Test
  Scenario: Fill out Automated Testing Data to update the status of the request with Pending Request Owner Response status
    ...
    #Given I open "https://harbourvesttest.appiancloud.com/suite/sites/client-service/page/client-service-requests/record/lUBfsMZM-I0--5FqVTNDp5aJ9ZmNSvOCpmbXr_hU_9A1mMudqUiMYDVB-0VO8f_RzndI8vUblG_ScN7k79tuIRKZnGZjVrp31mA2go7wG5CVkL7xNir/view/summary"
    Given I wait for "5" seconds
    
    #Navigate to update status related action, select Pending Request Owner Response status and then enter comments for the same
    Given I click on record related action "Update Status"
    Given I wait for "5" seconds
    Given I click on radio option "Pending Request Owner Response"
    Given I wait for "5" seconds
    ...
    Given I take screenshot "Pending Request Owner Response Status"
