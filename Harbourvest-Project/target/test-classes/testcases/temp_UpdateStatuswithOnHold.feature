...
Feature: Update status related action submission with status On Hold
  ...
  Scenario: Fill out Automated Testing Data to update the status of the request with On Hold status
    ...
    #Given I open "https://harbourvesttest.appiancloud.com/suite/sites/client-service/page/client-service-requests/record/lQBfsMZM-I0--5FqVTNDp5aJ9ZmNSvOCpmbXr_hU_9A1mMudqUiMYDVB-0VO8f_RzndI8vUblG_ScN7k7tuv2-NDCjCEKhc4ulVlhKKBrDihrSycbs/view/summary"
    Given I wait for "5" seconds
    
    #Navigate to update status related action, select On Hold status and then enter comments for the same
